...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vlayout_file_buttons = QtWidgets.QVBoxLayout()
        self.vlayout_file_buttons.setSpacing(5)
        self.vlayout_file_buttons.setObjectName("vlayout_file_buttons")
        self.pushbtn_load_file = QtWidgets.QPushButton(self.centralwidget)
        self.pushbtn_load_file.setMinimumSize(QtCore.QSize(250, 26))
        self.pushbtn_load_file.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.pushbtn_load_file.setObjectName("pushbtn_load_file")
        self.vlayout_file_buttons.addWidget(self.pushbtn_load_file, 0, QtCore.Qt.AlignHCenter)
        self.pushbtn_save_file = QtWidgets.QPushButton(self.centralwidget)
        self.pushbtn_save_file.setMinimumSize(QtCore.QSize(250, 26))
        self.pushbtn_save_file.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.pushbtn_save_file.setObjectName("pushbtn_save_file")
        self.vlayout_file_buttons.addWidget(self.pushbtn_save_file, 0, QtCore.Qt.AlignHCenter)
        self.verticalLayout.addLayout(self.vlayout_file_buttons)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushbtn_load_file.setText(_translate("MainWindow", "Загрузить файл..."))
        self.pushbtn_save_file.setText(_translate("MainWindow", "Выгрузить..."))
